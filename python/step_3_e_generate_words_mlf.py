...
script_tr_path = "config/{}/script_tr.hcopy".format(experiment_name)
script_te_path = "config/{}/script_te.hcopy".format(experiment_name)
train_output_filename = "output/{}/words_train.mlf".format(experiment_name)
test_output_filename = "output/{}/words_test.mlf".format(experiment_name)
...
with open(train_output_filename, mode="w") as file:
    file.write("\n".join(lines))
...
with open(test_output_filename, mode="w") as file:
    file.write("\n".join(lines))
